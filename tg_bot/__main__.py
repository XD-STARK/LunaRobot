...
If you have any questions on how to use me, head over to [support](@intense_chat)
...
DONATE_STRING = """no need sir.""".format(dispatcher.bot.first_name)
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                text="Add Misha robot to your group.",
